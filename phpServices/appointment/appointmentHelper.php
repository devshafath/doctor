...
if($query_no== 0){
	...
	$sql=mysql_query("SELECT 
						d.doctorID, d.doctorCode, d.password, d.name, d.sex, d.age, d.phone, ds.category, ds.state, ds.prescriptionStyle, ds.hospitalID, ds.photoSupport, ds.personCodeInitial, dc.name AS categoreyName
					FROM doctor d
